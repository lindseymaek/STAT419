...
```
There are clearly still issues with this data. Just by the ape index calculations alone, I can see that there was a misunderstanding about the measurement of wingspan. In the Vitruvious drawing, the armspan was perfectly equal to the height. According to 99boulders.com, an ape index of about 1 is considered normal. In my climbers dataset, there is one person with a positive 7 ape index, and most are much lower. And yet, our class seems to have a remarkable number of +15 and above superhumans...super apes...do apes even have that kind of ape index?
