...
source( paste0(  path.github, "humanVerseWSU/R/functions-sort.R" ) );
...
This algorithm sorts just through the vector linearly. Just like each piece of laundry from the dryer gets sorted based on its identity.

- Given the input, what is the number of tasks that need to be performed to sort using this approach?

I think this depends on the order, but at best, 7, and at most

- The stopping rule could be improved.  Any ideas on how?

Not exactly, I find it challenging to know what is totally happening here. I think that foundval is used to determine this, but I can't visualize a better method.
